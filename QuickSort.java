public class QuickSort {
   ...
   public static void quicksort(int[] arr, int low, int high, String version) {
       ...
       int pivot = arr[low];
       //change pivot according to version of quick sort
       ...
       while (left <= right) {
           ...
           //if still left havent crossed right swap those elements
           if (left <= right) {
               int temp = arr[right];
               arr[right] = arr[left];
               arr[left] = temp;
   ...
   public static void main(String[] args) {
       ...
       System.out.println("Quick Sort with First as Pivot");
       for(int val : arr) {
       ...
       System.out.println("Quick Sort with Median of First, Last, Middle as Pivot");
       for(int val : arr1) {
           System.out.println(val);
       }
   }
